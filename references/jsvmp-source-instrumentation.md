...
> **v2.5.0 新增文档，v3.6.1 对齐 MCP v1.5.1**。当前执行接口以 `instrumentation(action=...)` 为准；文中的旧工具名只用于解释能力来源。
>
...
- MCP 上游：https://github.com/WhiteNightShadow/camoufox-reverse-mcp（当前基线 v1.5.1）
